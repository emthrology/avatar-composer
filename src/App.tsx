...
import { CHARACTERS, PartCategory, PartCategoryDef } from './composer/constants'

// 썸네일 렌더 모드: ?thumb=<category>:<variantId> → 파츠 1개만 단독 렌더(오프라인 툴링).
// variant id 는 전역 고유라 캐릭터 축이 필요 없다. 전 캐릭터 카탈로그를 union 으로 window 에 노출
// → scripts/renderThumbs.mjs 가 모든 캐릭터(male1·female1…)의 변형 목록을 읽어 순회.
