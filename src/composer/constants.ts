...
//        'face'   = loadFacePart(GLB, Face 메시 교체 + 눈 본 graft + 표정 모프 미러)
...
export type PartCategory = 'tops' | 'bottoms' | 'hair' | 'accessory' | 'shoes' | 'face'
...
export const MODULE_PARTS: ModulePart[] = [
  ...
  { id: 'face',    label: 'Face',    detail: '눈 변형 · 모프', category: 'face',    kind: 'face',   url: '/avatars/male1/Face_eyesample.vrm' },
]
